  ...
  useEffect(() => {
    const loadVideoMetadata = async () => {
      try {
        setIsLoading(true);
        console.log(
          "🎬 Loading video metadata for:",
          video.videoUrl.substring(0, 100) + "..."
        );
        ...
        if (video.videoUrl.startsWith("data:")) {
          ...
          try {
            console.log(
              "🌐 Attempting to parse video metadata with Media Parser"
            );
            ...
            console.warn(
              "⚠️ Media parsing failed, using fallback:",
              parseError
            );
  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-white/60 mt-2">
              Professional video editing with captions & aspect ratio control
            </p>
          </div>
            ...
            <div className="relative">
              ...
              {showExportMenu && !isRendering && (
                <div className="absolute right-0 top-full mt-2 bg-black border border-white/20 rounded-lg shadow-xl min-w-64 z-50">
                  <div className="p-4">
                    <h3 className="text-white font-bold mb-3 uppercase tracking-wide">
                      Export Options
                    </h3>
                    ...
                    >
                      <div>
                        ...
                        <div className="text-white/60 text-sm">
                          Professional publishing with custom metadata
                        </div>
                      </div>
                    </button>
                    ...
                    <button
                      onClick={() => {
                        ...
                        a.download = `${video.title.replace(
                          /[^a-zA-Z0-9]/g,
                          "_"
                        )}_${aspectRatio}.mp4`;
                        a.click();
                    ...
                    >
                      <div>
                        ...
                        <div className="text-white/60 text-sm">
                          Copy video details to clipboard
                        </div>
                      </div>
                    </button>
                  </div>
                  ...
                  {captions.map((caption) => (
                    <div
                      ...
                      style={{
                        ...
                        width: `${
                          ((caption.end - caption.start) / videoDuration) * 100
                        }%`,
                      }}
        ...
        <div className="w-96 border-l border-white/20 p-8 overflow-y-auto">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block bg-black text-sm text-white/60 mb-2">
                  Text Color
                </label>
                <input
                  type="color"
          ...
          <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCaptionStartTime(parseFloat(e.target.value))
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCaptionEndTime(parseFloat(e.target.value))
                      }
                      className="w-full p-2 bg-black border border-white/20 text-white text-sm"
                    />
                  </div>
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {captions.map((caption) => (
                <div
                  key={caption.id}
                  className="border border-white/20 p-3 rounded border border-white/10"
                >
          ...
          {videoMetadata && (
            <div className="mb-8">
              ...
              <div className="space-y-2 text-sm text-white/60">
                <div>
                  Duration: {formatTime(videoMetadata.durationInSeconds || 0)}
                </div>
                <div>
      ...
      <YouTubePostModal
        ...
        defaultTitle={`AI Video Demo - ${new Date()
          .toISOString()
          .slice(0, 10)}`}
        defaultDescription={`🎬 Professional AI-Generated Video

Created with Veo-3 Technology
...
#AIVideo #VideoEditing #Captions #${aspectRatio.replace(
          ":",
          "x"
        )} #ContentCreation #SocialMedia #Professional #AI #VideoProduction #Digital #Tech #Innovation`}
      />
    </div>
  );
};

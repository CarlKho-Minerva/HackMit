        ...
        <main>
          <div className="mb-6">
            ...
            <textarea
              id="description"
              rows={10}
              className="w-full  border border-gray-700 rounded-lg p-3 text-gray-200 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-shadow duration-200"
              value={description}
